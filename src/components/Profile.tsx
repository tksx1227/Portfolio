        ...
        <div className={'flex flex-col md:flex-row md:justify-around md:space-x-10'}>
          ...
          <div>
            <p className={'text-sm leading-relaxed md:text-base'}>
              都内のIT企業に在籍中のソフトウェアエンジニア
              <br />
              <br />
              幼い頃からものづくりが好きで、工学系の進路へ進む。
              <br />
              <br />
              大学は情報系の学部へ進学し、入学後の講義にて初めてプログラミングに触れる。
              <br />
              <br />
              その後、ハッカソンや勉強会、インターンなどを重ね、エンジニアとしてのスキルを身につける。
              <br />
              <br />
              現在は都内のIT企業にてバックエンドエンジニアとして事業開発に従事している。
            </p>
          </div>
        </div>
      </div>
