  ...
  return (
    <section id='profile' className={'mb-28 mt-16 pt-8 md:mt-28 md:mb-52'}>
      <div className={'tracking-wider'}>
        <p className={'text-lg font-semibold text-indigo-800 dark:text-indigo-300'}>PROFILE</p>
        <h2 className={'text-2xl font-bold tracking-wider md:text-3xl'}>プロフィール</h2>
      </div>
      <div className={'glass-container-light mt-8 py-10 px-6 md:px-10 dark:glass-container-dark'}>
        <div className={'flex flex-col md:flex-row md:justify-around md:space-x-10'}>
          <div className={'flex-shrink-0 text-center'}>
            ...
            <p className={'text-lg font-medium text-center mt-4 tracking-wider'}>TOMORI</p>
            <div
              className={
            ...
            >
              <div>
                <a href='https://github.com/tksx1227' target='_brank' title='Github'>
                  <svg
                    width='35'
                    height='35'
                    viewBox='0 0 35 35'
              ...
              <div>
                <a href='https://twitter.com/tksx1227' target='_brank' title='Twitter'>
                  <svg
                    width='35'
                    height='35'
                    viewBox='0 0 35 35'
              ...
              <div>
                <a href='https://zenn.dev/tksx1227' target='_brank' title='Zenn'>
                  <svg
                    width='35'
                    height='35'
                    viewBox='0 0 35 35'
          ...
          <div className={'border border-gray-300 bg-gray-300 mb-6 md:mb-0'}></div>
          <div>
            <p className={'text-sm leading-relaxed md:text-base'}>
              ...
              <br />
              <br />
              大学は情報系の学部へ進路を決定し、入学後の講義にて初めてプログラミング（C言語）に触れる。
              <br />
              <br />
              学部１年生の頃から、講義外の時間でもプログラミングを学ぶ習慣を付け、独学で HTML, CSS,
              JavaScript の勉強を始める。
              <br />
              その後、ハッカソンや勉強会へ参加することで経験を積みながら、他の言語や機械学習などの新たな技術の学習もするようになる。
              <br />
              <br />
              現在は、42Tokyoに所属しコンピュータサイエンスなどの低レイヤの技術について学習している。
              <br />
              <br />
