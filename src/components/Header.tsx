...
export const Header = () => {
  ...
  return (
    <header className={"font-semibold bg-white absolute w-full py-6 px-3 border-b-2 md:text-lg md:p-10 dark:bg-dark-bandle"}>
      ...
      {isOpenMenu ? (
        <nav className={"transition-all absolute glass-container-light py-6 w-44 top-24 right-2 z-10 md:hidden dark:glass-container-dark"}>
          <div className={"space-y-6"}>
            ...
            <button className="mx-auto block p-1 bg-gray-600 dark:bg-white rounded-full" onClick={switchThemeMode}>
              {theme === "light"
                ? <MoonIcon className="w-5 h-5 text-white" />
                : <SunIcon className="w-5 h-5 text-gray-600" />
              }
